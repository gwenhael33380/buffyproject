...
$role_select = intval($_POST['role_select']);
$same_role = $role_select == $initial_role ? true : false;
...
//if( $role_select != $initial_role && !$same_role) :
//    $send_request = TRUE;
...
//                    elseif(!$same_email && !$same_pseudo) :
//                        $request =  "UPDATE users SET first_name = :first_name, last_name = :last_name, pseudo = :pseudo, email = :email, id_role = :id_role WHERE id = :id_user";
                    endif;
                endif;
                ...
                if(!$same_email) {
                    $req->bindValue(':email', $email, PDO::PARAM_STR);
//                    $req->bindValue(':id_role', $role_select, PDO::PARAM_STR);
                }
