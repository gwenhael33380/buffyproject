...
//                        UPDATE images SET file_name = :file_name WHERE id = :id_image; 
                    ...
                    ");
                $req->bindValue(':first_name', $img_name, PDO::PARAM_STR);
                $req->bindValue(':last_name', $img_name, PDO::PARAM_STR);
                $req->bindValue(':pseudo', $img_name, PDO::PARAM_STR);
                $req->bindValue(':email', $img_name, PDO::PARAM_STR);
                $req->bindValue(':password', $img_name, PDO::PARAM_STR);
                $req->bindValue(':file_name', $img_name, PDO::PARAM_STR);
                $req->bindValue(':id_image', $img_name, PDO::PARAM_STR);
